alter table user add column identityno varchar(18);
alter table user add column fileid varchar(100);
create table accotofileid(account varchar(18) not null,fileid varchar(100));
